    ...
    <footer className="bg-[#040725] text-white py-10 h-auto">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <Image src={Logo} alt="Mowdministries Logo" className="w-16 mb-4" />
          ...
          <p className="text-sm mt-2 italic text-[#CFCFCF]">
            <strong className=" text-[#fff]">Supervisory Authority:</strong> Tax
            Office Hamm (Westphalia)
          </p>
      ...
      {/* Bottom Section */}
      <div className="border-t border-gray-600 items-center justify-between mt-10 text-sm flex  py-4 md:px-6">
